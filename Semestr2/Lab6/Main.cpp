...
// biurowych. Urządzenia te są w różnych relacjach.
...
int main() {
  ...
  ptrPrint(s);
  Print(s);
  ptrPrint(dynamic_cast<const Papierozerne*>(s));
 
  std::cout << d->rozdzielczosc() << std::endl;
  std::cout << s->rozdzielczosc() << std::endl;
////////////////////////////////czyszczenie pamieci po alokacjach new
  delete skaner;
  delete AllInOne;
  delete drukarka;
////////////////////////////////
