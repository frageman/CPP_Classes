...
int main()
{
   ...
   std::vector<Pojazd*> pojazdy;                           // alternatywnie można skorzystać z std::vector
   ...
   pojazdy.push_back(mercedes_prototyp.Clone());
   pojazdy.push_back(ford_prototyp.Clone());
   pojazdy.push_back(trolejbus_prototyp.Clone());
